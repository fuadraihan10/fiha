...
export default function VinylPlayer({ youtubeId }: VinylPlayerProps) {
  ...
  const togglePlay = () => {
    ...
    if (isPlaying) {
      ...
      iframeRef.current.src = `https://www.youtube.com/embed/${youtubeId}?autoplay=1&loop=1&playlist=${youtubeId}&enablejsapi=1`
    }
